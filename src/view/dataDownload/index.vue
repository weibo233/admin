...
import detailDialog from "@/components/datadownDialog";
export default {
  name: "dataDownload",
  components: {
    delDialog,
  ...
  data() {
    return {
      ...
      DetailForm: {
        articleId: "", //文章ID
        author: "佚名", //作者
        categoryId: "7", //分类ID    6-招标公告，7-资料下载，8-资质证书，9-荣誉证书，10-工程案例，12-行政法规，13-建设法律，14-国务院文件，15-部门规章，16-地方法规
        content: "", //内容
        cover: "", //封面地址
        introduce: "", //简介
        pictures: "", //图片集地址
